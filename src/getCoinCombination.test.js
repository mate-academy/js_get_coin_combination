...
describe('getCoinCombination', () => {
  ...
  it('should return [2, 1, 1, 0] for 17 cents (2 pennies + 1 nickel + 1 dime)', () => {
  ...
  it('should return correct combination for a larger amount (99 cents)', () => {
    expect(getCoinCombination(99)).toEqual([4, 0, 2, 3]); // 4 pennies + 2 dimes + 3 quarters
  });

  it('should handle edge cases like 100 cents (1 dollar, should return 4 quarters)', () => {
