...
describe('getCoinCombination', () => {
  ...
  it(`should return [1, 0, 0, 0] for 1 cent (only pennies)`, () => {
    expect(getCoinCombination(1)).toEqual([1, 0, 0, 0]);
  });

  it(`should return [4, 0, 0, 0] for 4 cents (only pennies)`, () => {
  ...
  it('should return [0, 0, 1, 0] for 10 cents (one dime)', () => {
    expect(getCoinCombination(10)).toEqual([0, 0, 1, 0]);
  });

  it('should return [0, 0, 0, 1] for 25 cents (one quarter)', () => {
