...
describe('getCoinCombination', () => {
  ...
  it(`should returt [0, 0, 0, 0] if 'cents' = 0`, () => {
  ...
  it(`should returt [1, 0, 0, 0] if 'cents' = 1`, () => {
  ...
  it(`should returt [3, 0, 0, 0] if 0 < 'cents' < 5`, () => {
  ...
  it(`should returt [4, 0, 0, 0] if 'cents' = 4`, () => {
  ...
  it(`should returt [0, 1, 0, 0] if 'cents' = 5`, () => {
  ...
  it(`should returt [1, 1, 0, 0] if 'cents' = 6`, () => {
  ...
  it(`should returt [2, 1, 0, 0] if 5 < 'cents' < 10`, () => {
  ...
  it(`should returt [4, 1, 0, 0] if 'cents' = 9`, () => {
  ...
  it(`should returt [0, 0, 1, 0] if 'cents' = 10`, () => {
  ...
  it(`should returt [1, 0, 1, 0] if 'cents' = 11`, () => {
  ...
  it(`should returt [0, 1, 1, 0] if 10 < 'cents' < 25`, () => {
  ...
  it(`should returt [1, 1, 2, 0] if 'cents' = 24`, () => {
  ...
  it(`should returt [0, 0, 0, 1] if'cents' = 25`, () => {
  ...
  it(`should returt [1, 0, 0, 1] if'cents' = 26`, () => {
  ...
  it(`should returt [2, 1, 1, 2] if 'cents' = 67`, () => {
  ...
  it(`should returt [0, 0, 0, 0] if'cents' is NaN`, () => {
