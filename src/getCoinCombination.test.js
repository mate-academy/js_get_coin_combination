...
describe("getCoinCombination", () => {
  ...
  it("should return [3, 0, 2, 2] for 76 cents (25*2 + 10*2 + 1*3)", () => {
    expect(getCoinCombination(76)).toEqual([3, 0, 2, 2]);
  });
  ...
  it("should return [2, 1, 0, 3] for 83 cents (25*3 + 5 + 1*2)", () => {
    expect(getCoinCombination(83)).toEqual([2, 1, 0, 3]);
  });

  it("should handle large values correctly (e.g. 99 cents)", () => {
    expect(getCoinCombination(99)).toEqual([4, 0, 2, 3]); // 25*3 + 10*2 + 1*4 = 75 + 20 + 4 = 99
  });
});
