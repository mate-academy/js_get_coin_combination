...
describe('getCoinCombination', () => {
  ...
  it('should correctly split cents not divisible by 25 without remainder', () => {
    expect(getCoinCombination(40)).toEqual([0, 1, 1, 1]);
  });

  it('should throw an error for negative cents if necessary', () => {
    const testNegative = () => getCoinCombination(-1);
    expect(testNegative).toThrow('Invalid input: cents cannot be negative');
  });
});
