...
describe('getCoinCombination', () => {
  ...
  it('should return [0, 1, 2, 1] for 45 cents', () => {
  ...
  it('should return [3, 2, 1, 3] for 108 cents', () => {
    expect(getCoinCombination(108)).toEqual([3, 1, 0, 4]);
  });
  ...
  it('should return [2, 0, 1, 0] for 12 cents', () => {
