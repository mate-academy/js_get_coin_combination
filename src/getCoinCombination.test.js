...
describe('getCoinCombination', () => {
  ...
  it('should return [0, 0, 0, 0] when there are 0 cents', () => {
  ...
  it('should return [0, 0, 0, 0] for 0.5 cent', () => {
    expect(getCoinCombination(0.5)).toEqual([0, 0, 0, 0]);
  });

  it('should return [0, 0, 0, 0] for 0.9 cent', () => {
    expect(getCoinCombination(0.9)).toEqual([0, 0, 0, 0]);
  });
  ...
  it('should return [3, 1, 1, 3] for 93 cents', () => {
