...
describe('getCoinCombination', () => {
  ...
  it('should return [3, 0, 0, 2] for 53 cents', () => {
    expect(getCoinCombination(53)).toEqual([3, 0, 0, 2]);
  });

  it('should return correct combination for a large amount (99 cents)', () => {
    expect(getCoinCombination(99)).toEqual([4, 0, 2, 3]);
  });

  it('should return correct combination for 100 cents', () => {
